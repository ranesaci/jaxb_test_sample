 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ConsumerID" type="{http://firstdata.com/cmpwsapi/schemas/cmpmsg}ConsumerID" maxOccurs="2"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ID {
    ...
    protected List<ConsumerID> consumerID;
     ...
     * 
     */
    public List<ConsumerID> getConsumerID() {
        if (consumerID == null) {
            consumerID = new ArrayList<ConsumerID>();
        }
